...
#ifndef Dash_H
#define Dash_H
prog_char string_0[] PROGMEM = "SECL";   // "String 0" etc are strings to store - change to suit.
...
prog_char string_6[] PROGMEM = "CLT";   // "String 0" etc are strings to store - change to suit.
...
prog_char string_12[] PROGMEM = "ENRCH%";   // "String 0" etc are strings to store - change to suit.
...
prog_char string_18[] PROGMEM = "VE1%";   // "String 0" etc are strings to store - change to suit.
...
prog_char string_24[] PROGMEM = "ADV";   // "String 0" etc are strings to store - change to suit.
...
prog_char string_30[] PROGMEM = "EGO2%";   // "String 0" etc are strings to store - change to suit.
...
prog_char string_36[] PROGMEM = "TPSL";   // "String 0" etc are strings to store - change to suit.
prog_char string_37[] PROGMEM = "iTIMEX";
prog_char string_38[] PROGMEM = "BCDC";

// Then set up a table to refer to your strings.

PROGMEM const char *parameterName[] = 	   // change "string_table" name to suit
{   
  string_0,
  string_1,
  string_2,
